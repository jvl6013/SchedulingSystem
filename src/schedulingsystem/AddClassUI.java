...
public class AddClassUI {
    ...
    public AddClassUI(){
        ...
        JFrame addFrame = new JFrame("Add Class");
        ...
        addFrame.setSize(new Dimension(400, 600));
        ...
        String[] stTimes = {"8:00AM", "8:50AM", "9:05AM", "9:30AM", "10:10AM", 
                            "10:25AM", "11:10AM", "11:40AM","12:05AM", "12:25AM",
                            "1:00PM", "1:35PM", "2:00PM","2:30PM", "2:50PM", "3:05PM",
                            "3:45PM", "4:35PM", "5:00PM","6:00PM", "6:30PM",};
        ...
        addPanel.add(depComboBox);
        addPanel.add(className);
        addPanel.add(classNameField);
        addPanel.add(classDesc);
        addPanel.add(classDescField);
        addPanel.add(stClassTime);
        addPanel.add(stClassTimeCB);
        addPanel.add(classDuration);
        addPanel.add(classDurationCB);
        addPanel.add(credit);
        addPanel.add(creditComboBox);
